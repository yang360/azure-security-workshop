...
function Set-LabArtifacts {
    ...
    Invoke-WebRequest -Uri "https://raw.githubusercontent.com/yang360/azure-security-workshop/master/KeyVault-New-EncryptedVM.ps1" -OutFile C:\Users\student\Desktop\New-EncryptedVM.ps1
    # Create backup
    $path = "C:\Scripts"
    if(!(Test-Path $path))
    {
    ...
    Invoke-WebRequest -Uri "https://raw.githubusercontent.com/yang360/azure-security-workshop/master/KeyVault-New-EncryptedVM.ps1" -OutFile $($path + "\" + "New-EncryptedVM.ps1")
